import time, os, sys, random, json, requests, urllib.request
...
Space(5); mengetik("\033[97m|\033[95m*** Administrator Finder Tools ***")
Space(5); mengetik("\033[97m|\033[96mAuthor : \033[94mStar ")
Space(5); mengetik("\033[97m|\033[97m\033[93mShootz : \033[98mSunda Cyber Army\033[00m") 
Space(5); print "|\033[97m#########################################################\033[00m"

print(" \033[95m Harus Write protocol example : HTTPS:// or HTTP:// ex: http://www.ex.com , ex :https://www.ex.com ")
print(" \033[95m Anda Harus Write akhiran protocol web  EX: www.example.com/")
print("                                                                       ")
...
for hani in passe :
    ...
    try :
        ...
        print("                                                             ")
        print("\033[92m :::: ALERTE::: ADMIN PAGE KETEMU"+curl)
        print("_____________________________________________________________")
    except urllib.error.URLError as msg :
        print ("\033[91m **** MAMPUS GA KENA AWOAKAWOAK :p ::: "+curl)


print ("----------------------------------------------------------------------------------------")
print ("\033[93m     *sfx LU SEMUA BURIK CEM ASU :D")
print ("----------------------------------------------------------------------------------------")
